...
#' 
#' This function determines yield anomolies (ton/acre) based on Lobell et al. for a data frame with columns year, month, precip, tmin_c and tmax_c
#' @param minimum temperature
#' @param precipitation
#' @return yearly yield anomaly of almond production
#' @author Anna Calle and Tyler Cobian
